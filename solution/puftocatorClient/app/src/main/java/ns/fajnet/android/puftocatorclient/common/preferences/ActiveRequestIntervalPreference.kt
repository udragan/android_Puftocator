...
class ActiveRequestIntervalPreference(private val context: Context) : IPreference,
    SharedPreferences.OnSharedPreferenceChangeListener {

    // members ---------------------------------------------------------------------------------------------------------

    private var _value = Constants.PREFERENCE_DEFAULT_ACTIVE_REQUEST_INTERVAL
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        if (key == context.getString(R.string.settings_preference_location_active_request_interval_key)) {
            LogEx.d(Constants.TAG_PREFERENCE_ACTIVE_REQUEST_INTERVAL, "preference changed")
            _value = sharedPreferences
                .getInt(
                    context.getString(R.string.settings_preference_location_active_request_interval_key),
    ...
    private fun readExistingPreference() {
        ...
        LogEx.d(Constants.TAG_PREFERENCE_ACTIVE_REQUEST_INTERVAL, "read current value: $_value")
    }

    private fun registerPreferenceChangeListener() {
        LogEx.d(Constants.TAG_PREFERENCE_ACTIVE_REQUEST_INTERVAL, "register preference change listener")
        PreferenceManager.getDefaultSharedPreferences(context)
            .registerOnSharedPreferenceChangeListener(this)
    }

    private fun unregisterPreferenceChangeListener() {
        LogEx.d(Constants.TAG_PREFERENCE_ACTIVE_REQUEST_INTERVAL, "unregister preference change listener")
        PreferenceManager.getDefaultSharedPreferences(context)
