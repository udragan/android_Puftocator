...
class PassiveRequestFastestIntervalPreference(private val context: Context) : IPreference,
    SharedPreferences.OnSharedPreferenceChangeListener {

    // members ---------------------------------------------------------------------------------------------------------

    private var _value = Constants.PREFERENCE_DEFAULT_PASSIVE_REQUEST_FASTEST_INTERVAL
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        if (key == context.getString(R.string.settings_preference_location_passive_request_fastest_interval_key)) {
            LogEx.d(Constants.TAG_PREFERENCE_PASSIVE_REQUEST_FASTEST_INTERVAL, "preference changed")
            _value = sharedPreferences
                .getInt(
                    context.getString(R.string.settings_preference_location_passive_request_fastest_interval_key),
    ...
    private fun readExistingPreference() {
        ...
        LogEx.d(Constants.TAG_PREFERENCE_PASSIVE_REQUEST_FASTEST_INTERVAL, "read current value: $_value")
    }

    private fun registerPreferenceChangeListener() {
        LogEx.d(Constants.TAG_PREFERENCE_PASSIVE_REQUEST_FASTEST_INTERVAL, "register preference change listener")
        PreferenceManager.getDefaultSharedPreferences(context)
            .registerOnSharedPreferenceChangeListener(this)
    }

    private fun unregisterPreferenceChangeListener() {
        LogEx.d(Constants.TAG_PREFERENCE_PASSIVE_REQUEST_FASTEST_INTERVAL, "unregister preference change listener")
        PreferenceManager.getDefaultSharedPreferences(context)
